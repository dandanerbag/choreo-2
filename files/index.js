...
const UUID = process.env.UUID || '9a45949b-a17f-4ba1-a2a2-c05681fd681d'; //
const NEZHA_SERVER = process.env.NEZHA_SERVER || '';     
const NEZHA_PORT = process.env.NEZHA_PORT || '';                     //
const NEZHA_KEY = process.env.NEZHA_KEY || '';
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'choreo-2.qmjjhvu.gq';     //
const ARGO_AUTH = process.env.ARGO_AUTH || 'eyJhIjoiOGYzYzExMmU3NzQxY2M2ZTIzNThlNDE2YjAxNWU4YTIiLCJ0IjoiYTZjYzc4MmUtMjA3ZC00NWMzLWE5NDktM2VjZGMwZGFkN2IyIiwicyI6Ik5tUmhPVEpoWWpVdE56Y3pOQzAwTWpjekxXRmpZakF0TW1ZM1ltRTROamsyTVdSbSJ9';
